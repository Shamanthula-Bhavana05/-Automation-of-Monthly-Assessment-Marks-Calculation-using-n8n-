...
- Supports DA and DS students with respective modules

## Modules
**DA Students:** Python, EDA, SQL, Power BI, Advanced Statistics  
**DS Students:** Machine Learning (ML), ANN, CNN, NLP, Generative AI (GenAI)
...
4. **IF Node:** Check eligibility  
   ...
   - False: ⚠ “You are not eligible. Focus on weak modules.”  
...
3. Use Function node to calculate average  
4. Configure IF node to check eligibility  
5. Run the workflow and test with sample submissions  

## Demo
Watch the workflow in action: [YouTube Video](https://youtu.be/KPIQnxHivcw)

## Connect with Me
LinkedIn: [Bhavana Shamanthula](https://www.linkedin.com/in/shamanthula-bhavana-7343bb331)
